...
# TODO: newracer.php shows success by redirecting to checkin.php
curl_post newracer.php "carno=301&lastname=Adrogue&firstname=Nico&den=3,3" | expect_count '<tr' 2
curl_post newracer.php "carno=501&lastname=Adrogue&firstname=Tommy&den=5,5" | expect_count '<tr' 3
curl_post newracer.php "carno=101&lastname=Bender&firstname=Cole&den=1,1" | expect_count '<tr' 4
curl_post newracer.php "carno=302&lastname=Canino&firstname=Christopher&den=3,3" | expect_count '<tr' 5
curl_post newracer.php "carno=201&lastname=Fouda&firstname=Effa&den=2,2" | expect_count '<tr' 6
curl_post newracer.php "carno=502&lastname=Fouda&firstname=Ottou&den=5,5" | expect_count '<tr' 7
curl_post newracer.php "carno=401&lastname=Ciolfi&firstname=John&den=4,4" | expect_count '<tr' 8
curl_post newracer.php "carno=102&lastname=Colone&firstname=Ryan&den=1,1" | expect_count '<tr' 9
curl_post newracer.php "carno=402&lastname=Czubarow&firstname=Tony&den=4,4" | expect_count '<tr' 10
...
curl_post newracer.php "carno=206&lastname=Garber&firstname=Sam&den=2,2" | expect_count '<tr' 20
...
curl_post newracer.php "carno=108&lastname=Laing&firstname=Michael&den=1,1" | expect_count '<tr' 30
...
curl_post newracer.php "carno=306&lastname=O'Connor&firstname=Owen&den=3,3" | expect_count '<tr' 40
...
curl_post newracer.php "carno=409&lastname=Yasan&firstname=Alexander&den=4,4" | expect_count '<tr' 50
curl_post newracer.php "carno=112&lastname=Yasan&firstname=Anthony&den=1,1" | expect_count '<tr' 51
