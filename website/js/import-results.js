// Important differences between import-roster.js and other importers:
//
// For import-roster, we don't expect any draggable labels, and so don't require
// any draggable targets.
//
// import-roster assumes the csv file is in utf-8 (because the results file
// presumably was generated by us, not by some random spreadsheet program), and
// so doesn't bother to offer encoding choices.
//
// While import-roster displays the file content in a table and then uploads as
// a separate action, import-results wants to upload row-by-row immediately upon
...
$(function() {
  if (window.File && window.FileReader) {
    $('#csv_file').bind('change', function() {
      $('#import_results_button_div').removeClass('hidden');
    });
  } else {
  ...
  $('#import_results_button').click(function() {
