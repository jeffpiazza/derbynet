  ...
  <div class="settings_group">
    ...
    <div class="settings_group_settings">
      ...
      <p>
        ...
        <input id="use-subgroups" name="do-use-subgroups" type="checkbox"<?php
...
function photo_settings($category, $photo_dir_id, $photo_dir_value, $photo_size_prefix, $photo_size_value) {
	...
	echo '<input id="'.$photo_dir_id.'" name="'.$photo_dir_id.'" type="text"'
  ...
  <div class="settings_group">
    ...
    <div class="settings_group_settings">
      ...
      <p>
        ...
        <input id="use-master-sched" name="use-master-sched" type="checkbox"<?php
