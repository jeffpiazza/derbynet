...
curl_post action.php "action=heat-results&lane2=8.888" | check_success
curl_post action.php "action=select-heat&roundid=1&heat=2" | check_success
curl_post action.php "action=heat-results&lane4=8.888" | check_success
curl_post action.php "action=select-heat&roundid=1&heat=3" | check_success
curl_post action.php "action=heat-results&lane1=8.888" | check_success
