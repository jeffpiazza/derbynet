...
# Lions & Tigers heat 3
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="3"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 4
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="4"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 5
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="5"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 6
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="6"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 7
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="7"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 8
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="8"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 9
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="9"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 10
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="10"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 11
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="11"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 12
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="12"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 14
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="14"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 15
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="15"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 16
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="16"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
# Lions & Tigers heat 17
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'roundid="1"'
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="17"'
curl_post action.php "action=timer-message&message=STARTED" | check_success
...
curl_get "action.php?query=poll.coordinator" | grep current-heat | expect_one 'heat="1"'
curl_post action.php "action=timer-message&message=FINISHED&lane1=3&lane2=2&lane3=1&lane4=4" | check_success
check_heat_ready
