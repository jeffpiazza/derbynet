...
curl_postj action.php "action=json.award.present&key=award-3" | check_jsuccess
curl_getj "action.php?query=json.award.current" | \
    jq '(.current.reveal | not) and (.current.recipient | test("Howell.*"))' | expect_eq true

curl_getj "action.php?query=json.award.list" | jq '.awards | length' | expect_eq 4
curl_getj "action.php?query=json.award.list" | \
...
curl_postj action.php "action=json.racer.edit&racer=11&firstname=Carroll&lastname=Cybulski&carno=111&carname=Vroom&rankid=1&exclude=1" | check_jsuccess
curl_postj action.php "action=json.award.winner&awardid=1&racerid=11" | check_jfailure
curl_postj action.php "action=json.award.winner&awardid=1&racerid=2" | check_jsuccess
curl_postj action.php "action=json.award.winner&awardid=1&racerid=0" | check_jsuccess
curl_postj action.php "action=json.award.winner&awardid=1&racerid=2" | check_jsuccess

curl_postj action.php "action=json.award.edit&awardid=2&class_and_rank=3,3" | check_jsuccess
curl_postj action.php "action=json.award.edit&awardid=3&name=Third" | check_jsuccess
curl_postj action.php "action=json.award.edit&awardid=4&awardtypeid=2" | check_jsuccess

curl_postj action.php "action=json.award.winner&awardid=2&racerid=2" | check_jfailure

curl_getj "action.php?query=json.award.list" | jq '.awards | length' | expect_eq 4
curl_getj "action.php?query=json.award.list" | jq '.awards | map(select(.classid == 3)) | length' | expect_eq 1
curl_getj "action.php?query=json.award.list" | jq '.awards | map(select(.rankid == 3)) | length' | expect_eq 1
curl_getj "action.php?query=json.award.list" | \
...
curl_postj action.php "action=json.award.edit&awardid=2&class_and_rank=0,0" | check_jsuccess
curl_getj "action.php?query=json.award.list" | \
    jq '.awards | map(select(.awardid == 2)) | length == 1 and .[0].classid == 0' | \
    expect_eq true

curl_postj action.php "action=json.award.delete&awardid=3" | \
    jq '.awards | length' | expect_eq 3
curl_postj action.php "action=json.award.edit&awardid=new&awardtypeid=4&name=NewThird" | \
    jq '.awards | length' | expect_eq 4
curl_getj "action.php?query=json.award.list" | \
    jq '.awards | map(select(.awardid == 5)) | length == 1 and .[0].sort == 7' | \
    expect_eq true
curl_postj action.php "action=json.award.order&awardid_1=4&awardid_2=5&awardid_3=2&awardid_4=1" | \
...
curl_postj action.php "action=json.award.winner&awardid=6&racerid=48" | check_jfailure
...
curl_postj action.php "action=json.award.winner&awardid=7&racerid=1" | check_jfailure
# Move racer 1 to the previously empty subgroup and now the award can be granted
curl_postj action.php "action=json.racer.edit&racer=1&rankid=8" | check_jsuccess
curl_postj action.php "action=json.award.winner&awardid=7&racerid=1" | check_jsuccess

# Try some ad-hoc awards
# 21 = Derek Dreier, car 121
# 12 = Christopher Chauncey, car 212
curl_postj action.php "action=json.award.adhoc&racerid=21&awardname=Best%20Use%20Of%20Chocolate" | check_jsuccess
curl_postj action.php "action=json.award.adhoc&racerid=12&awardname=Most%20Glittery" | check_jsuccess
curl_postj action.php "action=json.award.adhoc&racerid=21&awardname=" | check_jsuccess

curl_getj "action.php?query=json.award.list" | expect_count 'Chocolate' 0
curl_getj "action.php?query=json.award.list" | \
...
curl_postj action.php "action=json.award.edit&awardid=new&awardtypeid=4&name=NewFourth" | check_jsuccess
curl_getj "action.php?query=json.award.list" | \
...
#
# curl_get "action.php?query=json.award.current" | check_failure
...
curl_postj action.php "action=json.award.present&reveal=0&key=speed-3" | check_jsuccess
curl_getj "action.php?query=json.award.current" | \
