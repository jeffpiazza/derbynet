...
curl_postj action.php "action=json.schedule.generate&roundid=7" | check_jsuccess
...
curl_postj action.php "action=json.schedule.generate&roundid=9" | check_jsuccess
