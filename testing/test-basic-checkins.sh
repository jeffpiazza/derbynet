...
#curl_post action.php "action=racer.pass&racer=19&value=1" | check_success
curl_post action.php "action=racer.pass&racer=21&value=1" | check_success
curl_post action.php "action=racer.pass&racer=23&value=1" | check_success
curl_post action.php "action=racer.pass&racer=25&value=1" | check_success
curl_post action.php "action=racer.pass&racer=27&value=1" | check_success
#curl_post action.php "action=racer.pass&racer=29&value=1" | check_success
curl_post action.php "action=racer.pass&racer=31&value=1" | check_success
curl_post action.php "action=racer.pass&racer=33&value=1" | check_success
curl_post action.php "action=racer.pass&racer=35&value=1" | check_success
...
curl_post action.php "action=racer.pass&racer=47&value=1" | check_success
