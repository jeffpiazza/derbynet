...
#curl_postj action.php "action=json.racer.pass&racer=19&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=21&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=23&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=25&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=27&value=1" | check_jsuccess
#curl_postj action.php "action=json.racer.pass&racer=29&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=31&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=33&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=35&value=1" | check_jsuccess
##curl_postj action.php "action=json.racer.pass&racer=37&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&barcode=PWD237&value=1" | check_jsuccess
##curl_postj action.php "action=json.racer.pass&racer=39&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&barcode=PWD508&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=41&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=43&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=45&value=1" | check_jsuccess
curl_postj action.php "action=json.racer.pass&racer=47&value=1" | check_jsuccess
...
curl_postj action.php "action=json.racer.edit&racer=39&firstname=Jeffress&lastname=Jamison&carno=139&carname=&rankid=3" | check_jsuccess
...
# den-changed racer.
curl_postj action.php "action=json.racer.add&firstname=Fred&lastname=Flintstone&carno=789&carname=&rankid=2" | check_jsuccess
