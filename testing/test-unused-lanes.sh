...
curl_postj action.php "action=json.settings.write&n-lanes=6" | check_jsuccess
...
curl_postj action.php "action=json.settings.write&unused-lane-mask=33&max-runs-per-car=0" | check_jsuccess
...
curl_postj action.php "action=json.settings.write&unused-lane-mask=42" | check_jfailure
...
curl_postj action.php "action=json.settings.write&unused-lane-mask=42" | check_jsuccess
