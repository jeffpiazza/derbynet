...
curl_getj "action.php?query=photo.next&racerid=0" | \
    jq '    (.racer["main-photo"] | test("photo.php/car/file/cropped/Car-1637.jpg/.*"))
        and (.racer["inset-photo"] | test("photo.php/head/file/cropped/head-A.jpg/.*"))
        and (.racer["next-photo"] | test("photo.php/car/file/cropped/Car-1638.jpg/.*"))' | \
    expect_eq true
...
curl_getj "action.php?query=photo.next&racerid=0&classids=2" | \
...
curl_getj "action.php?query=photo.next&racerid=0&classids=3" | \
...
curl_getj "action.php?query=photo.next&racerid=0&classids=2,3" | \
    jq '    (.racer["main-photo"] | test("photo.php/car/file/cropped/Car-1638.jpg/.*"))
        and (.racer["next-photo"] | test("photo.php/car/file/cropped/Car-1639.jpg/.*"))' | \
    expect_eq true

curl_getj "action.php?query=photo.next&racerid=15" | \
...
curl_getj "action.php?query=photo.next&racerid=31" | \
...
curl_getj "action.php?query=photo.next&racerid=32" | \
...
curl_getj "action.php?query=photo.next&racerid=33" | \
    jq '    (.racer.racerid == 35)
...
curl_getj "action.php?query=photo.next&racerid=81" |
...
curl_getj "action.php?query=photo.next&racerid=82" | jq '.racer? | not' | expect_eq true
