...
test "`xmllint --xpath "//option[contains(@data-catalog-entry, 'agg-class')][contains(@data-catalog-entry, 'c7')]/text()" $TMP_STANDINGS`" = "Younger" || test_fails Younger option

test "`xmllint --xpath "//div[@data-agg-classid=7]/ancestor::tr/td[3]" $TMP_STANDINGS`" \
...
test "`xmllint --xpath "//option[contains(@data-catalog-entry, 'agg-class')][contains(@data-catalog-entry, 'c8')]/text()" $TMP_STANDINGS`" = "Older" || test_fails Older option

test "`xmllint --xpath "//div[@data-agg-classid=8]/ancestor::tr/td[3]" $TMP_STANDINGS`" \
...
test "`xmllint --xpath "//option[contains(@data-catalog-entry, 'agg-class')][contains(@data-catalog-entry, 'c9')]/text()" $TMP_STANDINGS`" = "Scouts" || test_fails Scouts option

test "`xmllint --xpath "//div[@data-agg-classid=9]/ancestor::tr/td[3]" $TMP_STANDINGS`" \
