...
test `xmllint --xpath "//option[@data-aggregate=7]/text()" $TMP_STANDINGS` = "Younger" || test_fails Younger option
...
test `xmllint --xpath "//option[@data-aggregate=8]/text()" $TMP_STANDINGS` = "Older" || test_fails Older option
...
test `xmllint --xpath "//option[@data-aggregate=9]/text()" $TMP_STANDINGS` = "Scouts" || test_fails Scouts option
