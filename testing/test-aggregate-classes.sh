...
RANK_FINAL=`mktemp`
curl_post action.php "action=roster.new&classid=10&top=2&bucketed=1" | tee $RANK_FINAL | check_success

cat $RANK_FINAL | expect_count finalist 6
grep finalist $RANK_FINAL | expect_count 'racerid=\"92\"' 1
grep finalist $RANK_FINAL | expect_count 'racerid=\"90\"' 1
grep finalist $RANK_FINAL | expect_count 'racerid=\"89\"' 1
grep finalist $RANK_FINAL | expect_count 'racerid=\"95\"' 1
grep finalist $RANK_FINAL | expect_count 'racerid=\"26\"' 1
grep finalist $RANK_FINAL | expect_count 'racerid=\"1\"' 1
